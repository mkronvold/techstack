# Per-app alignment to the techstack baseline
...
Policy IDs that duplicate [`remediation.md`](./remediation.md) stay in sync conceptually; prefer this file for **how** to align an app and remediation for **priority tables**.
...
4. When done, update this file’s status line and any closed IDs in [`remediation.md`](./remediation.md).
