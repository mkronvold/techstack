...
| [`remediation.md`](./remediation.md) | Gaps in existing apps (`revu`, `tavi`, `themes`) to close in follow-up sessions |
...
| Registry profile | **Home:** GHCR. **WTG/org:** Artifactory `sv4.art/repo.ops` primary, GHCR optional mirror |
